...
// the theme: only the value below changes per course, the rendering lives in
// the shared LoginBackground.jsx.
//
//   motif: 'mobile'   → app-icon grid + phone outlines (mobile-apps courses)
