...
## ¿Cómo luce el método main?

```dart trycode=70ea035e72b031116992afc88dfb63ae
void main() {
  print('Hello, Dart!');
}
```
...
```dart trycode=00838af93b7981119311449fbd221205
void main() {
  int age = 25;
  double height = 1.75;
  String name = 'Ana';
...
## Ejemplo práctico: main y variables

```dart trycode=ae89df20a06833de993721c7223812d0
void main() {
  String name = 'Ana';
  int age = 25;
...
## Diagrama del flujo de un programa Dart
